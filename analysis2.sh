...
grabseqs sra -t 4 -m metadata1.csv SRR4018514 
grabseqs sra -t 4 -m metadata2.csv SRR4018515 
grabseqs sra -t 4 -m metadata3.csv SRR4018516 
grabseqs sra -t 4 -m metadata4.csv SRR4018517
...
echo "input data _ end at: $(date)"

echo "Analysis run_ start at: $(date)"
...
reademption gene_quanti \
  --project_path READemption_analysis \
  --processes 4 --features CDS,tRNA,rRNA 
